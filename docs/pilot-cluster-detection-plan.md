...
| **4 — Polish / port** | Terrain-backend parity, perf pass; (optional) bake episodes into the manifest at build time / Worker | Both backdrops correct; production path documented |
