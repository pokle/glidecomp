  ...
  return betterAuth({
    ...
    advanced: {
      ...
      database: {
        ...
        //
        // Not in any changelog, and unreported upstream as of this writing.
        // The two D1 `SQLITE_AUTH` issues better-auth HAS fixed (#10551,
        // #10976, both August 2026) are the MIGRATION path; this check came
        // later (#11168/#11178, September) and reintroduced the same
        // incompatibility on a different code path.
        //
