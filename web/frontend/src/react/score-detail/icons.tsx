/**
 * The report card's own icons — the map's maximise/minimise controls, the
 * link through to the analysis map, and the pin marking an explanation line
 * that can be shown on the map.
 *
...
export function AnalysisMapIcon() {
