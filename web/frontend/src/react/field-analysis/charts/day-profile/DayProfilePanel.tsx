 ...
 *
 * Everything here is measured from the pilots' own tracks. What the
 * METEOROLOGY says the day did lives in TaskWeatherPanel, which fronts the
 * page as its own section — the weather is grounding for reading every
 * metric, not a footnote to this family's charts.
 */
...
export function DayProfilePanel({
  ...
  const axis = useMemo(
    () =>
      buildTimeAxis(collectInstants(wind, climb, legs, timing), timeZone, [
        PLOT_LEFT,
        PLOT_RIGHT,
      ]),
